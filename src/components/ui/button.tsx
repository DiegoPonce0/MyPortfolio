  ...
  "inline-flex items-center justify-center rounded-lg text-sm font-medium transition-colors transition-transform duration-200 focus:outline-none disabled:opacity-60",
	{
		variants: {
			variant: {
				default:
					"bg-[#4F46E5] text-white hover:bg-[#6366F1] hover:shadow-md active:scale-95 focus:ring-2 focus:ring-[#4F46E5]/30 dark:bg-white dark:text-black dark:hover:bg-[#F3F4F6]",
				outline:
